    ...
    <div class="custom-container nav-container">
        ...
        <div class="nav-collapse" id="navCollapseContent">
            <ul class="nav-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/pages/articles.php">Tudástár</a></li>
                <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/pages/forum.php">Közösség</a></li>
                <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/pages/shop.php">Vásárlás</a></li>
                <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/pages/contact.php">Kapcsolat</a></li>
            ...
            <div class="nav-icons mobile-icons">
                <a href='<?= BASE_URL ?>/pages/shop.php' class='icon-button' title='Keresés'><i class='fa-solid fa-magnifying-glass'></i></a>
                ...
                <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true): ?>
                    <a href='<?= BASE_URL ?>/pages/profile.php' class='icon-button' title='Profil'><i class='fa-solid fa-user'></i></a>
