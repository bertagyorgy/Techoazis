...
<head>
    ...
    <style>
        /* Referencia alapú stílusok integrálása */
        .edit-container { 
            max-width: 850px; 
            margin: 2rem auto; 
            padding: 2.5rem; 
        ...
        .form-group label { display: block; margin-bottom: 0.6rem; font-weight: 600; color: var(--admin-secondary); font-size: 0.95rem; }
        .form-control { 
            width: 100%; 
            padding: 0.85rem; 
        ...
        .btn-submit-style {
            background: linear-gradient(135deg, var(--admin-accent), #ff9e6d);
            color: white;
            padding: 14px 32px;
            border-radius: 10px;
            border: none;
        ...
        .btn-back:hover { color: var(--admin-secondary); }
    </style>
    <script>
